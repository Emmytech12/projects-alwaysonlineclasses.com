            ...
            <label>
                <div class="img-div" title="Click To Upload Exam Pix">
                    <div class="img-in" >
                        ...
                        <input type="file" id="subject_passport" style="display:none" accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif" onchange="exam_pix.UpdatePreview(this);"/>
                    </div>
                </div>
            </label>
        </div>
            ...
            <label>
                <div class="img-div" title="Click To Upload Exam Pix">
                    <div class="img-in">
                        ...
                        <input type="file" id="exam_passport" style="display:none" accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif" onchange="exam_pix.UpdatePreview(this);"/>
                    </div>
                </div>
            </label>
        </div>
            ...
            <label>
                <div class="img-div" title="Click To Sub Topic Video">
                    <div class="img-in">
                        ...
                        <input type="file" id="sub_topic_passport" style="display:none" accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif" onchange="exam_pix.UpdatePreview(this);" />
                    </div>
                </div>
            </label> 
        </div>
...
<div class="overlay-off-div">
    <div class="slide-form-div center-form-div animated fadeInUp ">
        ...
        <div class="img-back-div">
            <legend style="cursor:pointer;">Click to Upload Video <i class="bi-upload"></i></legend><br/><br/>
            <label>
            ...
            <label>
                <div class="img-div bottom-image-div" title="Click To Sub Topic Video">
                    <div class="img-in">
                        ...
                        <input type="file" id="video_passport" style="display:none" accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif" onchange="exam_pix.UpdatePreview(this);" />
                    </div>
                </div>
            </label> 
        </div>
    ...
    function showVideo(input) {
        ...
        <div class="container-back-div container-back-div2 sb-container">
            <div class="inner-div">
                ...
                <script>tinymce.init({selector:'#video_objective',  // change this value according to your HTML
